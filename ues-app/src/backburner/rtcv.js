// App.js backup with rtcv included
...
//                                     <path clip-rule="evenodd" fill="white" fill-rule="evenodd" transform="translate(350.999 14.3985)" d="M 20.244 8.014 L 13.857 26.209 H 26.811 L 20.455 8.014 H 20.244 Z M 24.702 0 L 40.97 43.201 H 32.716 L 28.89 32.476 H 11.869 L 8.194 43.201 H 0 L 16.267 0 H 24.702 Z" />
//                                     <path clip-rule="evenodd" fill="white" fill-rule="evenodd" transform="translate(394.539 26.6293)" d="M 1.145 0 H 25.878 V 2.923 L 9.64 25.186 H 25.968 V 30.97 H 0 V 27.505 L 15.997 5.784 H 1.145 V 0 Z" />
//                                     <path clip-rule="evenodd" fill="white" fill-rule="evenodd" transform="translate(424.786 26.6293)" d="M 27.806 0 V 30.97 H 20.455 V 26.902 H 20.335 C 19.371 28.309 18.08 29.408 16.464 30.201 C 14.847 30.994 13.035 31.392 11.027 31.392 C 7.431 31.392 4.695 30.372 2.817 28.333 C 0.939 26.295 0 23.127 0 18.829 V 0 H 7.381 V 17.955 C 7.381 20.566 7.898 22.529 8.933 23.845 C 9.967 25.16 11.528 25.818 13.618 25.818 C 15.686 25.818 17.342 25.09 18.588 23.634 C 19.833 22.178 20.455 20.274 20.455 17.925 V 0 H 27.806 Z" />
...
//                                     <path clip-rule="evenodd" fill="#f25022" fill-rule="evenodd" transform="translate(0.00499725 0.00601196)" d="M 0 34.219 H 34.219 V 0 H 0 V 34.219 Z" />
//                                     <path clip-rule="evenodd" fill="#7fba00" fill-rule="evenodd" transform="translate(37.779)" d="M 0 34.219 H 34.219 V 0 H 0 V 34.219 Z" />
//                                     <path clip-rule="evenodd" fill="#00a4ef" fill-rule="evenodd" transform="translate(0 37.779)" d="M 0 34.219 H 34.219 V 0 H 0 V 34.219 Z" />
//                                     <path clip-rule="evenodd" fill="#ffb900" fill-rule="evenodd" transform="translate(37.779 37.779)" d="M 0 34.219 H 34.219 V 0 H 0 V 34.219 Z" />
//                                 </svg>
//                             </a>
//                         </div>
//                     </div>
...
//     // TODO: remove frames that are from prior loops
//     syncData = () => {
//         let frame = null;
//         const frames = [];
