...
Press this button to deploy the people counting application to the Azure public cloud:
...
###
This application can execute against a Virtual Azure Eye AI Device in the cloud:
...
To install this reference application you must have Owner or Contributor level access to the target subscription.  This deployment will create resources within the following Azure namespaces. These resource providers must be enabled on the subscription.
...
**Note :** If you want to use Azure Cloud Shell for the deployment, follow the [instructions here](cloudshell-deployment-steps.md)